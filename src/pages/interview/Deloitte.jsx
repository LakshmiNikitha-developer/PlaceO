...
export default function Deloitte() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        setLoading(true);
        // Fetch from TCS until Deloitte-specific questions are available
        const response = await fetch(
          `http://localhost:3000/api/tests?category=interview&subcategory=tcs`
        );
  ...
  return (
    <div className="interview-container">
      <h1>Deloitte Interview Questions</h1>
